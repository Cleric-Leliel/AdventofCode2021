...
print("Card " +str(loser) +" is last with "+str(chiporder[cardmax]) +" at call index "+str(cardmax))
winner = loser                  #The First Shall Be Last And the Last Shall Be First
winningcall = cardmax           #And Now I don't have to redo any below Math 
